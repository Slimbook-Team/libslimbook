...
#define SLB_KBL_BRIGHTNESS_ZERO         0x01
...
/* Gets AC auto boot flag */
extern "C" int slb_qc71_ac_auto_boot_get(uint32_t* value);

/* Sets AC auto boot flag */
extern "C" int slb_qc71_ac_auto_boot_set(uint32_t value);
